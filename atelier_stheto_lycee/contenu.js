...
window.ATELIER_DATA = {
  ...
  geste: {
    ...
    etapes: [
      ...
      { t: "Entendre B1 et B2", d: "À chaque battement, deux bruits. B1 = fermeture des valves mitrale et tricuspide, c'est le début de la systole (le cœur se contracte et éjecte le sang). B2 = fermeture des valves aortique et pulmonaire, c'est le début de la diastole (le cœur se relâche et se remplit)." },
      ...
      { t: "Placer le brassard et la membrane", d: "Brassard autour du bras nu, juste au-dessus du coude ; membrane du stéthoscope au pli du coude, sur l'artère." },
